...
def step_decay(epoch):
    # initialize the base initial lr, drop factor, and epochs to "drop every"
    initAlpha=0.01
    factor=0.25
    dropEvery=5

    # computer lr for the current epoch
...
ap.add_argument("-o","--output", required=True,
    help = "path to the output loss/accuract plot")
ap.add_argument("-b","--bnorm", required=True,
    help = "yes or no depending on whether BatchNormalization is needed or not")
