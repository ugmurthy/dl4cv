...
# labels now contain int representing class - for eg. if there are 3 classes then labels will be
# 0,1,2 depending on the class label
...
# le.classs_ is an array of unique class names
...
for i in np.arange(0, len(imagePaths), bs):
	...
	# our actual features
	# verticall stack list of array of images
