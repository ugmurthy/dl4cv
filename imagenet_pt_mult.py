...
# remove non image files using list of valid extensions
for f in imgfiles:
...
print ("[INFO] list of image files {}".format(imgfiles))

# classify each image in imagefiles

for imagef in imgfiles:
    ...
    image = load_img(join(imgpath,imagef), target_size=inputShape)
    ...
    orig = cv2.imread(join(imgpath,imagef))
